...
export function SectionProdutos() {
    return (
        <section className="produtos">
            <div className="container">
                <div className="produtos-item">
                    ...
                    <p>
                        ...
                        escolha e, entre 1800 e 1850, tentou-se o cultivo noutras
                        regiões:o João Alberto Castelo Branco trouxe mudas do Pará
                    </p>
                </div>
                <div className="produtos-item">
            ...
            <a href="#" className="btn-produtos">Saiba Mais</a>
        </section>
    )
}